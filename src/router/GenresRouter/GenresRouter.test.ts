...
import { Genre, GenreDocument, User } from 'model';
...
describe('GenresRouter', () => {
  ...
  describe('GET /:id', () => {
    ...
    it('should return 404 if no genre with the given id is exists', async () => {
  ...
  describe('DELETE /:id', () => {
    ...
    it('should return the removed genre', async () => {
      ...
      expect(res.body).toHaveProperty(
        '_id',
        (genre._id as unknown as ObjectId).toHexString()
      );
      expect(res.body).toHaveProperty('name', genre.name);
    });
  });
